...
window.DECK_CHAPTERS.push([
  {
    ...
    accent: 'blue',
    chapterNumber: '03',
    chapterTitle: '반복 작업을 없애려고 만든 개발 생산성 도구',
    meta: [
      { label: '분류', value: '개발 도구 · AI 코딩 에이전트' },
      { label: '역할', value: '1인 개발 · 설계부터 구현까지 (기여도 100%)' },
    ...
    summary: '도구를 쓰는 데서 멈추지 않고, AI 코딩 에이전트의 핵심 동작을 C#으로 밑바닥부터 구현했습니다.',
    chapterSubtitle: '새 기능을 어트리뷰트 한 줄로 붙이는 확장 구조를 설계했고, 이 구조 덕분에 도구를 붙일 대상이 Revit이든 언리얼이든 코어는 그대로 씁니다.'
  },
